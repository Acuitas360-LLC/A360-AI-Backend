...
def main():
    ...
    parser.add_argument("--input", default="agent_trace_1.json", help="Path to agent_trace.json")
    parser.add_argument("--payload_out", default="payload_store_snowflake_1.json", help="Output payload store file")
