...
DB_CONFIG = {
    ...
    "port": _env_or_default("MYSQL_PORT", "3306"),
    "user": _env_or_default("MYSQL_USER", "root"),
    "password": _env_or_default("MYSQL_PASSWORD", "root@1234"),
    "database": _env_or_default("MYSQL_DATABASE", "drug_db")
}
...
SNOWFLAKE_CONFIG = {
    ...
    "warehouse": _env_or_default("SNOWFLAKE_WAREHOUSE", "PALSONIFY_COMPUTE"),
    "database": _env_or_default("SNOWFLAKE_DATABASE", "PALSONIFY"),
    "schema": _env_or_default("SNOWFLAKE_SCHEMA", "PALSONIFY_SCHEMA"),
}
